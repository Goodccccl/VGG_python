...
pt_file = r"runs\savedModel_99_accuracy_0.9976904988288879.pth"
wts_file = r"runs\savedModel_99_accuracy_0.9976904988288879.wts"

# Initialize
device = select_device('cuda:0')
# Load model
model = torch.load(pt_file, map_location=device).float()
